...
public final class DownloadWeiboMain {
    ...
    private static void 下载明星1() throws IOException {
        for (Constants.IDNameEntity entity : Constants.明星1()) {
            start(new File("F:/weibo_log", entity.screen_name), new File("H:/weibo1", entity.screen_name), 2025, 1, 1,
                    2099, 12, 31);
        }
    }
    ...
    private static void 下载明星2() throws IOException {
        for (Constants.IDNameEntity entity : Constants.明星2()) {
            start(new File("F:/weibo_log", entity.screen_name), new File("H:/weibo2", entity.screen_name), 2025, 1, 1,
                    2099, 12, 31);
        }
    }
    ...
    private static void 下载明星3() throws IOException {
        for (Constants.IDNameEntity entity : Constants.明星3()) {
            start(new File("F:/weibo_log", entity.screen_name), new File("H:/weibo3", entity.screen_name), 2025, 1, 1,
                    2099, 12, 31);
        }
    }
    ...
    private static void 下载欧美() throws IOException {
        for (Constants.IDNameEntity entity : Constants.欧美()) {
            start(new File("F:/weibo_log", entity.screen_name), new File("H:/weibo-欧美", entity.screen_name), 2000, 1, 1,
                    2011, 5, 4);
            start(new File("F:/weibo_log", entity.screen_name), new File("H:/weibo-欧美", entity.screen_name), 2024, 9, 1,
                    2099, 5, 4);
        }
    }
    ...
    private static void searchAndDownload(Collection<String> weiboLogFolderNames, Collection<String> searchKeys,
        ...
        for (String weiboLogFolderName : weiboLogFolderNames) {
            searchAndDownloadOne(searchKeys, mainWeiboLogFolder, mainOutputFolder, weiboLogFolderName);
        }
    }

    /** 处理单个日志目录的搜索下载。 */
    private static void searchAndDownloadOne(Collection<String> searchKeys, File mainWeiboLogFolder,
            File mainOutputFolder, String weiboLogFolderName) throws IOException {
    ...
    private static void 下载() throws IOException {
        // start(new File("F:/weibo_log/我是一个小朋友小啊小朋友"), new File("H:\\weibo\\我是一个小朋友小啊小朋友","韩雪"));
        // searchAndDownloadOne(Constants.searchKeys2(), new File("F:/weibo_log"), new File("H:\\weibo", "我是一个小朋友小啊小朋友"), "我是一个小朋友小啊小朋友");
        // start(new File("F:/weibo_log/梦醒忒远"), new File("H:\\weibo\\梦醒忒远", "韩雪"), "韩雪");
        // searchAndDownloadOne(Constants.searchKeys2(), new File("F:/weibo_log"), new File("H:\\weibo", "梦醒忒远"), "梦醒忒远");
        // start(new File("F:\\weibo_log\\BellaHadidCN"), new File("H:\\weibo-欧美\\BellaHadidCN"));
        // start(new File("F:\\weibo_log\\KendallJCN"), new
        // File("H:\\weibo-欧美\\KendallJCN"));
        // start(new File("F:/weibo_log", "安雅泰勒-乔伊"), new File("H:\\weibo", "安雅泰勒-乔伊"));
        // start(new File("F:/weibo_log", "安雅泰勒乔伊"), new File("H:\\weibo", "安雅泰勒乔伊"));
        // start(new File("F:/weibo_log", "SydneySweeneyCN"), new File("H:\\weibo",
        // "SydneySweeneyCN"));
        // start(new File("F:/weibo_log", "MadisonBeerUpdates"), new File("H:\\weibo",
        // "MadisonBeerUpdates"));
        // start(new File("F:/weibo_log", "凯瑟琳纽顿0208"), new File("H:\\weibo",
        // "凯瑟琳纽顿0208"));
        // start(new File("F:/weibo_log", "MckennaGraceCN"), new File("H:\\weibo",
        // "MckennaGraceCN"));
        // start(new File("F:/weibo_log", "Angel_AlessandraAmbrosio"), new
        // File("H:\\weibo", "Angel_AlessandraAmbrosio"));
        // start(new File("F:/weibo_log", "Rachelcook1995"), new File("H:\\weibo",
        // "Rachelcook1995"),"RachelCook");
        // start(new File("F:/weibo_log", "Rachelcook1995"), new File("H:\\weibo",
        // "Rachelcook1995"),"rachelc00k");
        // start(new File("F:/weibo_log", "Rachelcook1995"), new File("H:\\weibo",
        // "Rachelcook1995"),"rachel cook​​​");
        // start(new File("F:/weibo_log", "Rachelcook1995"), new File("H:\\weibo",
        // "Rachelcook1995"),"Rachel Cook");
        // start(new File("F:/weibo_log", "rachelcook14"), new File("H:\\weibo",
        // "rachelcook14"));
        // start(new File("F:/weibo_log", "MetFreckle"), new File("H:\\weibo",
        // "MetFreckle"));
        // start(new File("F:/weibo_log", "·AllForZendaya·"), new File("H:\\weibo",
        // "·AllForZendaya·"), 2024, 12, 1, 2099, 1, 11);
        //
        // start(new File("F:/weibo_log", "Official_权恩妃"), new File("H:\\weibo",
        // "Official_权恩妃"));
        // start(new File("F:/weibo_log", "伊藤舞雪_real"), new File("H:\\weibo",
        // "伊藤舞雪_real"));
        // start(new File("F:/weibo_log", "EstherHeesch吧"), new File("H:\\weibo",
        // "EstherHeesch吧"));
        // start(new File("F:/weibo_log", "希岛爱理Yua"), new File("H:\\weibo", "希岛爱理Yua"));
        // start(new File("F:/weibo_log", "八掛海_real"), new File("H:\\weibo",
        // "八掛海_real"));
        // start(new File("F:/weibo_log", "瀧本雫葉_real"), new File("H:\\weibo",
        // "瀧本雫葉_real"));
        // start(new File("F:/weibo_log", "七濑爱丽丝_real"), new File("H:\\weibo",
        // "七濑爱丽丝_real"));
        // start(new File("F:/weibo_log", "小宵虎南_konancmore"), new File("H:\\weibo",
        // "小宵虎南_konancmore"));
        // start(new File("F:/weibo_log", "河北彩伽-元河北彩花"), new File("H:\\weibo",
        // "河北彩伽-元河北彩花"));
        // start(new File("F:/weibo_log", "河北彩伽"), new File("H:\\weibo", "河北彩伽"));
        // start(new File("F:/weibo_log", "松岡李那LinahM"), new File("H:\\weibo",
        // "松岡李那LinahM"), 2024, 12, 1, 2099, 1, 11);

        // start(new File("F:\\weibo_log\\田丽"), new File("F:\\weibo2\\田丽"), 2000, 1, 1,
        // 2014, 12, 31);
        // start(new File("F:\\weibo_log\\Nana谈莉娜"), new File("F:\\weibo2\\Nana谈莉娜"),
        // false, 2000, 1, 1, 2015, 6, 18);
        // start(new File("F:/weibo_log", "凉森明里MiaMio"), new File("F:\\weibo5",
        // "凉森明里MiaMio"), 2023, 10, 25, 2024, 04, 20);

        // start(new File("F:/weibo_log/那年今日丨吴宣仪"), new File("F:/weibo/那年今日丨吴宣仪"), 2000,
        // 1, 1, 2019, 3, 14);
        // start(new File("F:\\weibo_log\\火箭少女101官博"), new File("F:\\weibo\\火箭少女101官博"),
        // false, 2000, 1, 1, 2025, 1, 1, "吴宣仪");
        // start(new File("F:\\weibo_log\\高叶ChLoe"), new File("E:\\weibo2\\高叶ChLoe"),
        // 2000, 1, 1, 2010, 8, 15);
        // start(new File("F:\\weibo_log\\金晨工作室"), new File("E:\\weibo2\\金晨工作室"), 2000,
        // 1, 1, 2019, 3, 7);
        // start(new File("F:\\weibo_log\\古晨"), new File("F:\\weibo2\\古晨"), 2000, 1, 1,
        // 2019, 5, 7);
        // start(new File("F:\\weibo_log\\嘉行传媒"), new File("H:\\weibo-祝绪丹\\嘉行传媒"),
        // "祝绪丹");
        ...
        // start(new File("F:/weibo_log", "夏梦工作室官微"), new File("H:\\weibo1",
        // "夏梦工作室官微"));
        // start(new File("F:/weibo_log", "高露"), new File("H:\\weibo1", "高露"));
        // start(new File("F:/weibo_log", "赵樱子"), new File("H:\\weibo1", "赵樱子"));
        // start(new File("F:/weibo_log", "赵奕欢Chloe"), new File("H:\\weibo1",
        // "赵奕欢Chloe"));
        // start(new File("F:/weibo_log", "李欣汝"), new File("H:\\weibo1", "李欣汝"));
        // start(new File("F:/weibo_log", "袁嘉敏Kaman"), new File("H:\\weibo1",
        // "袁嘉敏Kaman"));
        // start(new File("F:/weibo_log", "周秀娜Chrissienana"), new File("H:\\weibo1",
        // "周秀娜Chrissienana"));
        // start(new File("F:/weibo_log", "周韦彤Cica"), new File("H:\\weibo1",
        // "周韦彤Cica"));
        ...
        // start(new File("F:/weibo_log", "龙一一Adela"), new File("H:\\weibo",
        // "龙一一Adela"));
        ...
        // start(new File("F:/weibo_log", "O0笨笨呀0O-梁洁"), new File("H:\\weibo",
        // "O0笨笨呀0O-梁洁"));
        // start(new File("F:/weibo_log", "Vlinder·蝴蝶效应丨关晓彤"), new File("H:\\weibo",
        // "Vlinder·蝴蝶效应丨关晓彤"));
        // start(new File("F:/weibo_log", "高海寧"), new File("H:\\weibo", "高海寧"));
        // start(new File("F:/weibo_log", "吉娜爱丽丝Gina"), new File("H:\\weibo",
        // "吉娜爱丽丝Gina"));
        ...
        // start(new File("F:/weibo_log", "Yakisa彭雅琦"), new File("H:\\weibo",
        // "Yakisa彭雅琦"));
        // start(new File("F:/weibo_log", "王瑞子715"), new File("H:\\weibo", "王瑞子715"));
        // start(new File("F:/weibo_log", "月与玫瑰__娜然Naran"), new File("H:\\weibo",
        // "月与玫瑰__娜然Naran"));
        // start(new File("F:/weibo_log", "AprilFox_Naran娜然"), new File("H:\\weibo",
        // "AprilFox_Naran娜然"));
        // start(new File("F:/weibo_log", "娜然丨NaranDaily"), new File("H:\\weibo",
        // "娜然丨NaranDaily"));
        // start(new File("F:/weibo_log", "娜然Naran工作室"), new File("H:\\weibo",
        // "娜然Naran工作室"));
        ...
        start(new File("F:/weibo_log", "_陳菲"), new File("H:\\weibo", "_陳菲"));
        start(new File("F:/weibo_log", "左小青"), new File("H:\\weibo", "左小青"));
        ...
        start(new File("F:/weibo_log", "蓝心ZoeZhang"), new File("H:\\weibo",
        "蓝心ZoeZhang"));
        start(new File("F:/weibo_log", "吳千語全球官方後援會"), new File("H:\\weibo",
        "吳千語全球官方後援會"));
        ...
        start(new File("F:/weibo_log", "火箭少女101官博"), new File("H:\\weibo",
        "火箭少女101官博"), "吴宣仪");
        start(new File("F:/weibo_log", "青蛙公主爱凌"), new File("H:\\weibo", "青蛙公主爱凌"));
        start(new File("F:/weibo_log", "张馨予工作室"), new File("H:\\weibo", "张馨予工作室"));
        start(new File("F:/weibo_log", "唐嫣工作室"), new File("H:\\weibo", "唐嫣工作室"));
        start(new File("F:/weibo_log", "洋气YOUNGCHIC"), new File("H:\\weibo",
        "洋气YOUNGCHIC"), "宋妍霏");
        start(new File("F:/weibo_log", "沈羽洁er"), new File("H:\\weibo", "沈羽洁er"));
        start(new File("F:/weibo_log", "于雯_"), new File("H:\\weibo", "于雯_"));
        start(new File("F:/weibo_log", "Karena吳千語"), new File("H:\\weibo",
        "Karena吳千語"));
        start(new File("F:/weibo_log", "徐璐工作室"), new File("H:\\weibo", "徐璐工作室"));
        start(new File("F:/weibo_log", "姜珮瑶"), new File("H:\\weibo", "姜珮瑶"));
        start(new File("F:/weibo_log", "无尽热恋丨1226x1109"), new File("H:\\weibo",
        "无尽热恋丨1226x1109"));
        start(new File("F:/weibo_log", "潘霜霜Shayla"), new File("H:\\weibo",
        "潘霜霜Shayla"));
        start(new File("F:/weibo_log", "李凯馨Eleanor工作室"), new File("H:\\weibo",
        "李凯馨Eleanor工作室"));
        ...
        start(new File("F:/weibo_log", "林逸欣Shara"), new File("H:\\weibo",
        "林逸欣Shara"));
        ...
        start(new File("F:/weibo_log", "朱珠工作室官方微博"), new File("H:\\weibo",
        "朱珠工作室官方微博"));
        start(new File("F:/weibo_log", "朱珠ZhuZhu"), new File("H:\\weibo",
        "朱珠ZhuZhu"));
        start(new File("F:/weibo_log", "乔欣Bridgette"), new File("H:\\weibo",
        "乔欣Bridgette"));
        start(new File("F:/weibo_log", "毛林林NIKITA"), new File("H:\\weibo",
        "毛林林NIKITA"));
        ...
        start(new File("F:/weibo_log", "劉心悠Annie"), new File("H:\\weibo",
        "劉心悠Annie"));
        start(new File("F:/weibo_log", "刘雨欣yoyoliu"), new File("H:\\weibo",
        "刘雨欣yoyoliu"));
        start(new File("F:/weibo_log", "许晴随行笔记"), new File("H:\\weibo", "许晴随行笔记"));
        start(new File("F:/weibo_log", "Summer许晴工作室"), new File("H:\\weibo",
        "Summer许晴工作室"));
        ...
        start(new File("F:/weibo_log", "小艾同学下课了吗"), new File("H:\\weibo",
        "小艾同学下课了吗"));
        ...
        start(new File("F:/weibo_log", "Gen1es_欧阳娣娣"), new File("H:\\weibo",
        "Gen1es_欧阳娣娣"));
        start(new File("F:/weibo_log", "刘承羽Natasha"), new File("H:\\weibo",
        "刘承羽Natasha"));
        start(new File("F:/weibo_log", "明星生图严选"), new File("H:\\weibo", "明星生图严选"));
        start(new File("F:/weibo_log", "李庚希Teresa"), new File("H:\\weibo",
        "李庚希Teresa"));
        start(new File("F:/weibo_log", "刘芸"), new File("H:\\weibo", "刘芸"));
        start(new File("F:/weibo_log", "刘芸工作室官方微博"), new File("H:\\weibo",
        "刘芸工作室官方微博"));
        ...
        start(new File("F:/weibo_log", "孙佳奇Titania"), new File("H:\\weibo4",
        "孙佳奇Titania"));
        start(new File("F:/weibo_log", "张馨月Carina"), new File("H:\\weibo4",
        "张馨月Carina"));
        start(new File("F:/weibo_log", "王子文Ava"), new File("H:\\weibo4", "王子文Ava"));
        start(new File("F:/weibo_log", "郭小仙儿-郭珺"), new File("H:\\weibo4",
        "郭小仙儿-郭珺"));
        ...
        start(new File("F:/weibo_log", "Yakisa彭雅琦"), new File("H:\\weibo4",
        "Yakisa彭雅琦"));
        start(new File("F:/weibo_log", "李菲儿love"), new File("H:\\weibo4",
        "李菲儿love"));
        start(new File("F:/weibo_log", "刘佳玺-"), new File("H:\\weibo4", "刘佳玺-"));
        start(new File("F:/weibo_log", "张凯莹-ky"), new File("H:\\weibo4", "张凯莹-ky"));
        start(new File("F:/weibo_log", "歐陽娣娣Didi工作室"), new File("H:\\weibo4",
        "歐陽娣娣Didi工作室"));
        start(new File("F:/weibo_log", "NINGx2宁艺卓"), new File("H:\\weibo4",
        "NINGx2宁艺卓"));
        start(new File("F:/weibo_log", "宋雨琦_G-I-DLE"), new File("H:\\weibo4",
        "宋雨琦_G-I-DLE"));
        start(new File("F:/weibo_log", "SNH48-费沁源--"), new File("H:\\weibo4",
        "SNH48-费沁源--"));
        ...
        start(new File("F:/weibo_log", "-GeminiNa-"), new File("H:\\weibo4",
        "-GeminiNa-"));
        start(new File("F:/weibo_log", "李源冰Brianne"), new File("H:\\weibo4",
        "李源冰Brianne"));
        ...
        start(new File("F:/weibo_log", "何琢言"), new File("H:\\weibo4", "何琢言"));
        start(new File("F:/weibo_log", "余冰慧的微博"), new File("H:\\weibo4", "余冰慧的微博"));
    }
    ...
    static void start(File doneListFolder, File outputFolder, boolean downloadVideo,
        ...
        try {
            ...
            log.entrySet().removeIf(
                    entry -> !matchDate(entry.getKey(), startYear, startMonth, startDay, endYear, endMonth, endDay)
